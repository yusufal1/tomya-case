...
const Reference = () => {
  return (
    <div className='sm:container mx-auto mt-36 mb-5'>
        <h2 className='subTitle text-center'>İş Birliklerimiz</h2>
        <div className='mt-10 boxShadow flex md:flex-row flex-col lg:gap-28 md:gap-14 sm:px-20 px-4 py-6 sm:mx-0 mx-4 items-center rounded-lg'>
